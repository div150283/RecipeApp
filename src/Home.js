      ...
      <div className="Site">
        ...
        <Container className="Site-content">
          ...
          <CardDeck className="row mb-1">
            <a href="/category/sweets" className="col-md">
              <Card>
                <CardImg top width="60%" src={sweetsImg} alt="Sweets" className="card-img-top"/>
                <CardBody>
                  <CardTitle style={{display: 'flex', justifyContent: 'center'}}><h3>Sweets</h3></CardTitle>
                </CardBody>
              </Card>
            </a>
            ...
            <a href="/category/nonveg" className="col-md">
              <Card>
                <CardImg top width="60%" src={nonvegImg} alt="Nonveg" className="card-img-top"/>
                <CardBody>
                  <CardTitle style={{display: 'flex', justifyContent: 'center'}}><h3>Non Vegetarian</h3></CardTitle>
                </CardBody>
              </Card>
            </a>
          </CardDeck>
